...
/* 22. <if> -> if <condition> then <endl> <stmt list> end */
...
/* 23. <if else> -> if <condition> then <endl> <stmt list> else <endl> <stmt list> end */
int ReduceIfElse(SYNTAX_TREE* node)
{
    if (node->numChildren != 9) return 23;
    SYNTAX_TREE* condition1 = node->children[1];
    SYNTAX_TREE* stmt_list1 = node->children[4];
...
/* 24. <for loop> -> for <identifier> = <arithmetic> to <arithmetic> do <endl> <stmt list> loop */
int ReduceForLoop(SYNTAX_TREE* node)
{
    if (node->numChildren != 10) return 24;
    SYNTAX_TREE* identifier1 = node->children[1];
...
/* 25. <while loop> -> while <condition> do <endl> <stmt list> loop */
int ReduceWhileLoop(SYNTAX_TREE* node)
{
    if (node->numChildren != 6) return 25;
    SYNTAX_TREE* condition1 = node->children[1];
    SYNTAX_TREE* stmt_list1 = node->children[4];
...
/* 28. <l-value> -> <identifier> */
int ReduceLValueA(SYNTAX_TREE* node)
{
    if (node->numChildren != 1) return 28;
    SYNTAX_TREE* identifier1 = node->children[0];
...
/* 30. <l-value> -> <reference> . <identifier> */
...
/* 31. <l-value> -> <reference> [ <expr> ] */
int ReduceLValueD(SYNTAX_TREE* node)
{
    if (node->numChildren != 4) return 31;
    SYNTAX_TREE* reference1 = node->children[0];
...
{
    if (node->numChildren != 1) return 32;
...
/* 33. <condition> -> <condition> and <logic> */
...
/* 34. <condition> -> <condition> or <logic> */
...
/* 35. <condition> -> <condition> nor <logic> */
...
/* 36. <condition> -> <condition> xor <logic> */
...
{
    if (node->numChildren != 1) return 37;
...
{
    if (node->numChildren != 1) return 39;
...
{
    if (node->numChildren != 1) return 54;
...
{
    if (node->numChildren != 1) return 57;
...
{
    if (node->numChildren != 3) return 58;
    SYNTAX_TREE* expr1 = node->children[1];
...
/* 66. <reference> -> <reference> ( <arguments> ) */
...
{
    if (node->numChildren != 2) return 69;
...
/* 74. <dictionary init> -> <dictionary init> , <identifier> : <expr> */
int ReduceDictionaryInitA(SYNTAX_TREE* node)
{
    if (node->numChildren != 5) return 74;
...
/* 75. <dictionary init> -> <identifier> : <expr> */
...
{
    if (node->numChildren != 1) return 77;
...
{
    if (node->numChildren != 6) return 78;
    SYNTAX_TREE* expr1 = node->children[4];
...
int ReduceReferenceE(SYNTAX_TREE* node)
{
...
/* 80. <reference> -> duck . <identifier> ( ) */
int ReduceReferenceF(SYNTAX_TREE* node)
{
    if (node->numChildren != 5) return 80;
    SYNTAX_TREE* identifier1 = node->children[2];
...
/* 81. <reference> -> duck . <identifier> ( <arguments> ) */
int ReduceReferenceG(SYNTAX_TREE* node)
{
    if (node->numChildren != 6) return 81;
    SYNTAX_TREE* identifier1 = node->children[2];
    SYNTAX_TREE* arguments1 = node->children[4];
...
/* 82. <reference> -> duck . <identifier> */
int ReduceReferenceH(SYNTAX_TREE* node)
{
...
int CompileNode(SYNTAX_TREE* node)
{
    ...
    switch (node->production)
    {
        ...
        case 0x17: return ReduceIfElse(node);
        case 0x18: return ReduceForLoop(node);
        case 0x19: return ReduceWhileLoop(node);
        case 0x1A: return ReduceAssignmentA(node);
        case 0x1B: return ReduceAssignmentB(node);
        case 0x1C: return ReduceLValueA(node);
        case 0x1D: return ReduceLValueB(node);
        case 0x1E: return ReduceLValueC(node);
        case 0x1F: return ReduceLValueD(node);
        case 0x20: return ReduceExpr(node);
        case 0x21: return ReduceConditionA(node);
        case 0x22: return ReduceConditionB(node);
        case 0x23: return ReduceConditionC(node);
        case 0x24: return ReduceConditionD(node);
        case 0x25: return ReduceConditionE(node);
        case 0x26: return ReduceLogicA(node);
        case 0x27: return ReduceLogicB(node);
        case 0x28: return ReduceComparisonA(node);
        case 0x29: return ReduceComparisonB(node);
        case 0x2A: return ReduceComparisonC(node);
        case 0x2B: return ReduceComparisonD(node);
        case 0x2C: return ReduceComparisonE(node);
        case 0x2D: return ReduceComparisonF(node);
        case 0x2E: return ReduceComparisonG(node);
        case 0x2F: return ReduceArithmeticA(node);
        case 0x30: return ReduceArithmeticB(node);
        case 0x31: return ReduceArithmeticC(node);
        case 0x32: return ReduceArithmeticD(node);
        case 0x33: return ReduceArithmeticE(node);
        case 0x34: return ReduceTermA(node);
        case 0x35: return ReduceTermB(node);
        case 0x36: return ReduceTermC(node);
        case 0x37: return ReduceFactorA(node);
        case 0x38: return ReduceFactorB(node);
        case 0x39: return ReduceFactorC(node);
        case 0x3A: return ReduceFinalA(node);
        case 0x3B: return ReduceFinalB(node);
        case 0x3C: return ReduceFinalC(node);
        case 0x3D: return ReduceFinalD(node);
        case 0x3E: return ReduceFinalE(node);
        case 0x3F: return ReduceFinalF(node);
        case 0x40: return ReduceReferenceA(node);
        case 0x41: return ReduceReferenceB(node);
        case 0x42: return ReduceReferenceC(node);
        case 0x43: return ReduceArgumentsA(node);
        case 0x44: return ReduceArgumentsB(node);
        case 0x45: return ReduceObjectA(node);
        case 0x46: return ReduceObjectB(node);
        case 0x47: return ReduceObjectC(node);
        case 0x48: return ReduceArrayInitA(node);
        case 0x49: return ReduceArrayInitB(node);
        case 0x4A: return ReduceDictionaryInitA(node);
        case 0x4B: return ReduceDictionaryInitB(node);
        case 0x4C: return ReduceBooleanA(node);
        case 0x4D: return ReduceBooleanB(node);
        case 0x4E: return ReduceReferenceD(node);
        case 0x4F: return ReduceReferenceE(node);
        case 0x50: return ReduceReferenceF(node);
        case 0x51: return ReduceReferenceG(node);
        case 0x52: return ReduceReferenceH(node);
    default:
